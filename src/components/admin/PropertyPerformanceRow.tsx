...
const PropertyPerformanceRow = ({ property }: { property: AdminProperty }) => {
    return (
        <tr className='border-b border-cream-300 last:border-b-0 hover:bg-cream-100 transition-colors'>
            ...
            <td className='py-4 px-4 text-ink-900 tabular-nums'>{property.totalBookings}</td>
            <td className='py-4 px-4 text-ink-900 tabular-nums'>₦{property.totalRevenue.toLocaleString()}</td>

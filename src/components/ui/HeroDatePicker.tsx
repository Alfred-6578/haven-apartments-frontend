    ...
    return (
        <div className={wrapperClass}>
            <DayPicker
                ...
                classNames={{
                    // month: 'bg-cream-50',
                    month_caption: 'font-serif text-xl text-ink-900 mb-4',
                    ...
                    button_previous: 'absolute right-8 -top-1 h-11 w-11 rounded-full hover:bg-cream-200 transition-colors flex items-center justify-center cursor-pointer',
                    button_next: 'absolute right-0 -top-1 h-11 w-11 rounded-full hover:bg-cream-200 transition-colors flex items-center justify-center cursor-pointer',
                    
                    // The SVG chevron icon inside each button
                    chevron: 'h-5 w-5 fill-ink-700',
